...
source("createInferenceFigure.txt.R")
...
#second figure similar to podophyllum 
oParListTrue = list(shape1 = 96.8758327457031, shape2= 190.50919224519 ) 
dParListTrue = list(shape1= 1.09249185415366, shape2= 15.9406182894344 )
